      ...
      <Item>
        ...
        >
          <Grid spacing={1} container item xs={12}>
            ...
            <Grid item xs={1}>
            <Button variant="contained"  style = {{minWidth:5,height:56,backgroundColor:'fuchsia'}}>E</Button>
            </Grid>
          </Grid>
          ...
          <Grid xs={3.5} item spacing={2}>
            <Button variant="contained" style = {{minWidth:80,height:37 ,backgroundColor:'fuchsia'}}>=</Button>      
          </Grid>
          <Grid item xs={1} >
